...
console.log(`- Total 17 Terobosan Agresif   : Rp ${aggressiveTotal.toLocaleString('id-ID')} (Target: Rp 39.500.000.000)`);
console.log(`- TARGET KOMITMEN MINIMUM      : Rp 50.500.000.000`);
console.log(`- TOTAL AGREGAT HORIZON 2030   : Rp ${grandTotal.toLocaleString('id-ID')} (Target: Rp 67.500.000.000)`);
console.log(`------------------------------------------------------`);

if (baselineTotal === 28000000000 && aggressiveTotal === 39500000000 && grandTotal === 67500000000) {
  console.log(`🎉 [AUDIT SUKSES] Seluruh 25 inisiatif presisi dan sesuai dokumen resmi BLUD STP!`);
} else {
